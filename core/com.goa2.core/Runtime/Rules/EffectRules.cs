...
namespace Goa2.Rules
{
    public static class EffectRules
    {
        ...
        private static int Radius(ContentCatalog catalog, GameState state, ActiveEffect effect) => (catalog.Card(effect.SourceCardId).SubtypeValue ?? 0) + state.Players[effect.ControllerSeat].RangeBonus;
