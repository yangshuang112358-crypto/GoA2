...
GoA2 电子版重启工程。[BATCH-02](docs/planning/BATCH-02.md)正在持续开发：Unity与Windows程序已可运行，测试模式、四边折叠界面和地图缩放已接入。拔枪、快速突刺、神枪手/一枪爆头、闪耀之刃、五张防御及静电封锁/打断施法可操作，支持击败/复活、兵线推进、轮末回收/移兵、连续升级、补偿和下一轮。偏转/反射屏障已接入本人强制弃牌与非相邻远程免疫。共享核心Unity221项通过；本次.NET运行遇Windows应用控制限制，历史158项通过另记。真实窗口已验收基础界面、战场、战斗、升级、轮末衔接、持续效果、来源取消与屏障反制；十五份场景可无窗口运行或可见播放。正式数据为6英雄、108牌、254格。其余牌效、其他免疫与完整联动、紫卡文字及联网仍未实现，当前不宣称全部规则对局完成。
...
|---|---|
| 英雄 | 6 |
| 卡牌 | 108；每英雄18；12张implemented、96张data_only，未宣称全部行为矩阵/集成完成 |
| 地图 | 254格、44障碍、8种区域标识 |
| 现存照片 / OCR文字 | 24张 / 12份 |
| Git恢复照片 | 1张，单独保留 |
