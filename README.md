...
GoA2 电子版重启工程。[BATCH-02](docs/planning/BATCH-02.md)正在持续开发：Unity与Windows程序已可运行，测试模式、四边折叠界面和地图缩放已接入。十一张主要攻击、八张防御及静电封锁/打断施法可操作，支持击败/复活、兵线推进、轮末回收/移兵、连续升级、补偿和下一轮。投掷牌已接入可选本人弃牌与条件距离；屏障、近身格挡/还击支持强制弃牌、空手反击与条件免疫，带头冲锋检查相邻友方小兵。共享核心Unity367项通过；本次.NET运行遇Windows应用控制限制，历史158项通过另记。真实窗口覆盖基础交互及上述代表牌，二十九份场景可无窗口运行或可见播放。正式数据为6英雄、108牌、254格。其余牌效、其他免疫与完整联动、紫卡文字及联网仍未实现，当前不宣称全部规则对局完成。
