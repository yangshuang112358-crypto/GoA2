...
GoA2 电子版重启工程。[BATCH-02](docs/planning/BATCH-02.md)正在持续开发：Unity与Windows程序已可运行，测试模式、四边折叠界面和地图缩放已接入。首批两张主要攻击与三张主要防御可操作，支持击败/复活、兵线推进、轮末回收/移兵、连续升级、补偿和下一轮。共享核心Unity与.NET各124项通过；真实窗口已验收基础界面、战场、战斗、升级及轮末推进衔接；八份场景可无窗口运行或可见播放。正式数据为6英雄、108牌、254格。其余牌效、持续效果、紫卡文字与联网仍未实现，当前不宣称全部规则对局完成。
...
|---|---|
| 英雄 | 6 |
| 卡牌 | 108；每英雄18；5张implemented、103张data_only，未宣称全部行为矩阵/集成完成 |
| 地图 | 254格、44障碍、8种区域标识 |
| 现存照片 / OCR文字 | 24张 / 12份 |
| Git恢复照片 | 1张，单独保留 |
...
按1/2/3/4或点击左侧立即切换角色。地图支持滚轮缩放、中/右键拖动、Home全图；四周区域可折叠。地图点击只产生预选，确认后才提交规则命令。拔枪/快速突刺可开始主要攻击，防御者切至自己席位用手牌响应；复活先选出生点再继续原牌。升级时右侧选颜色、下方选两张候选之一，确认后获得未选牌的永久图标；8级紫卡独立展示，文字仍待实装。
