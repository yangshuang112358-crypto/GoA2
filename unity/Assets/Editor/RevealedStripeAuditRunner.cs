...
namespace Goa2.Editor
{
    ...
    public static class RevealedStripeAuditRunner
    {
        public static void Run()
        {
            ...
            if(Array.IndexOf(args,"-goaStripeEditor")<0) throw new InvalidOperationException("An explicit editor audit launch is required.");
            ...
            var size=Activator.CreateInstance(sizeType,BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance,null,new object[] {Enum.Parse(typeEnum,"FixedResolution"),width,height,"Goa2 stripe QA"},null);
