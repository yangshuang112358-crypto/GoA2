    ...
    public sealed partial class GameScreen
    {
        ...
        private bool RenderCombatChoice(VisualElement parent, GameView view)
        {
            ...
            if(choice.Kind=="effect_target")
            {
                ...
                bool minionMove=choice.ResumeAt=="friendly_minion_move";
                var targetTitle=Text(PlayerName(choice.ChooserSeat)+(minionMove ? "选择技能范围内的一个友方小兵。" : otherMove ? "选择原攻击目标旁的另一个单位移动，或跳过。" : choice.Optional ? "选择另一名敌方英雄，或跳过。" : "选择牌文作用的英雄。"),"section-title");targetTitle.name="effect-target-choice";parent.Add(targetTitle);
